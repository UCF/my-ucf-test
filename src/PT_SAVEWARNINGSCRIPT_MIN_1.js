...
function psConfirmSW(saveOKEvent, saveCancelEvent, pWin) {
 ...
 var agTarget = typeof document.getElementById("ICAGTarget") != 'undefined' && document.getElementById("ICAGTarget"); var agChanged = agTarget ? (typeof document.getElementById("ICUOW") != 'undefined' && document.getElementById("ICUOW") != null && document.getElementById("ICUOW").value != "N" ? true : false) : false; if (agChanged)
 return psConfirmFluid("Save Warning", "Do you want to save your changes?" , "YesNo", saveOKEvent, saveCancelEvent, "All the Changes in the Activity Guide will be lost. Click Yes to go back and save", pWin); }
...
function psConfirmClassic(msgTitle, msg, msgType, event1, event2, pWin) {
 ...
 shtml += "<div id='alertbutton'><a class='PSPUSHBUTTON Left' style = 'border:0;'><span><input type=button id='#ALERTOK' name='#ALERTOK' class='PSPUSHBUTTONTBOK' value='"; shtml += (sOK + "' tabindex='0' alt='" + sOK + "' title='" + sOK + "' onclick='" + event2 + ";closeMsg(this);' /></span></a>"); shtml += ("<a class='PSPUSHBUTTON Left' style = 'border:0;'><span><input type=button id='#ALERTCANCEL' name='#ALERTCANCEL' class='PSPUSHBUTTONTBOK' value='"); shtml += (sCancel + "' tabindex='0' alt='" + sCancel + "' title='" + sCancel + "' onclick='" + event1 + ";closeMsg(this);' /></span></a></div>"); } else {
