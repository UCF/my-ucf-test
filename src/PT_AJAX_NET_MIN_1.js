...
reduceScrollareaHeight:function(id, data)
 ...
 this.processAttributes(attrs, obj);  if (this.formname + "hdrdivPT_WORK_PT_BUTTON_BACK" == id) {
 ...
 removeHide(obj); obj.innerHTML = "";  obj.innerHTML = sCleanData; }
...
finalCall:function()
{
 ...
 if (isModeless(MTop().modId) && this.bModal == 2) {
